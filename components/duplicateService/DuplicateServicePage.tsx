...
import { useDuplicateServicePage } from "./useDuplicateServicePage";

export default function DuplicateServicePage({ serviceId }: { serviceId: string }) {
  const {
    serviceData,
    formData,
    errors,
    ...
    handleGalleryRemove,
    saveChanges,
  } = useDuplicateServicePage(serviceId);
  ...
  return (
    <section className="space-y-5 pb-18 md:pb-0">
      ...
      <StickyActionBar
        ...
        onSubmit={() => undefined}
        singleActionLabel="Create Duplicate"
